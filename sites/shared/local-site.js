(async () => {
  ...
  const render = () => {
    ...
    const profileNotice = locale === "es" ? "Perfiles e imágenes ilustrativos para esta demostración." : locale === "en" ? "Illustrative profiles and images for this demonstration." : "Perfis e imagens ilustrativos para esta demonstração.";
